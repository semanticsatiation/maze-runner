...
export class TileKeysComponent implements OnInit {
  ...
  keys = [["start-tile", "Right Click = Start"], ["end-tile", "Left Double Click = End"], ["wall", "Single Click/Hold = Walls"], ["seen-tile", "Seen Tiles"], ["final-tile", "Final Path"], ["current-tile", "Leading Tile"], ["weight", "Weight"]];
